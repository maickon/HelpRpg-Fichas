...
$tag->html('lang="pt-br"');
	...
	if($s->exist('login')):
		...
		$parametros['nomes'] = array(
									...
									array(CAMPANHAS, AVENTURAS,HISTORIAS, CENARIOS, CONTOS),
		...
		$parametros['links']  = array(
									...
									array("#", ROOTPATHURL.AVENTURASPATH, ROOTPATHURL.HISTORIASPATH, ROOTPATHURL.CENARIOSPATH, ROOTPATHURL.CONTOSPATH),
		...
		$campanhas_label 		= array(CAMPANHAS, AVENTURAS, HISTORIAS, CENARIOS, CONTOS);
		$campanhas_link 		= array("#", ROOTPATHURL.AVENTURASPATH, ROOTPATHURL.HISTORIASPATH, ROOTPATHURL.CENARIOSPATH, ROOTPATHURL.CONTOSPATH);
