...
$tag->html('lang="pt-br"');
	...
	if($s->exist('login')):
		...
		$parametros['nomes'] = array(
									...
									array(UTILITARIOS, ROLAR_DADOS, GERADOR_DE_NOMES, GERADOR_DE_FICHAS_BASE, GERADOR_DE_CARACTERISTICAS, GERADOR_DE_MUNDOS, GERADOR_DE_MASMORRAS, GERADOR_DE_NPCS, GERADOR_DE_MONSTROS),
		...
		$parametros['links']  = array(
									...
									array("#", ROLLDICE, NAMEGENERATION, FICHASBASEGENERATION, CARACTERISTICASGENERATION, MAPWORDPATH, DUNGEONPATH, NPCGENERATEPATH, MONSTERGENERATEPATH),
		...
		//array('#','?v=pt-br', '?v=en')
		$utilitarios_label 		= array(UTILITARIOS, ROLAR_DADOS, GERADOR_DE_NOMES, GERADOR_DE_FICHAS_BASE, GERADOR_DE_CARACTERISTICAS, GERADOR_DE_MUNDOS, GERADOR_DE_MASMORRAS, GERADOR_DE_NPCS, GERADOR_DE_MONSTROS);
		$utilitarios_link 		= array("#", ROLLDICE, NAMEGENERATION, FICHASBASEGENERATION, CARACTERISTICASGENERATION, MAPWORDPATH, DUNGEONPATH, NPCGENERATEPATH, MONSTERGENERATEPATH);
