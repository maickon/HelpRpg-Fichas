...
define('COMO_USAR_PATH', ROOTPATHURL.'pages/como-usar/');
define('VERSAO_ESTRANGEIRA_PATH', ROOTPATHURL.'pages/versoes-estrangeira/');
define('QUEM_SOU_PATH', ROOTPATHURL.'pages/quem-sou/');
